...
public class PaginaWeb {
    ...
    public void afegeixTaula(ArrayList<ArrayList<String>> taula,
        ...
        Iterator<ArrayList<String>> itFiles = taula.iterator();
    ...
    public void escriuPagina(PrintWriter printer) {
        System.out.println(paginaWeb.toString());
    }

    public String pageToString() {
        String report = paginaWeb.toString();
        System.out.println("REPORUTO                      " + report);
        return report;
    }
