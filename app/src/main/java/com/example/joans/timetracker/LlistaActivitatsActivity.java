 ...
 * <li>tecla o botó "back" puja de nivell: anem al projecte stop del les
...
public class LlistaActivitatsActivity extends AppCompatActivity {
    ...
    public final void onCreate(final Bundle savedInstanceState) {
        ...
        View.OnClickListener createActivityListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(tag, "click en boton de new activity");
        ...
        createActivityButton.setOnClickListener(createActivityListener);
     ...
     * Activity.
     *
     * @param savedInstanceState objecte de classe Bundle, que no fem servir.
     */
    @Override
     ...
     * apaisat o al revés.
     *
     * @param savedInstanceState Bundle que de fet no es fa servir.
     ...
     *
     * @param newConfig nova configuració {@link Configuration}
     */
    @Override
